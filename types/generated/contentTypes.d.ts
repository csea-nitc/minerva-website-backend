...
export interface ApiCompletedPhDCompletedPhD extends Struct.SingleTypeSchema {
  collectionName: 'completed_ph_ds';
  info: {
    description: '';
    displayName: 'Completed-PhDS';
    pluralName: 'completed-ph-ds';
    singularName: 'completed-ph-d';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::completed-ph-d.completed-ph-d'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCseaCsea extends Struct.CollectionTypeSchema {
  collectionName: 'cseas';
  info: {
    displayName: 'Csea';
    pluralName: 'cseas';
    singularName: 'csea';
  ...
  attributes: {
    ...
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::csea.csea'> &
      Schema.Attribute.Private;
    pdf: Schema.Attribute.Component<'pdf.pdf', true>;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String;
...
export interface ApiDeparmentBrochureDeparmentBrochure
  extends Struct.SingleTypeSchema {
  collectionName: 'deparment_brochures';
  info: {
    displayName: 'Deparment-Brochure';
    pluralName: 'deparment-brochures';
    singularName: 'deparment-brochure';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::deparment-brochure.deparment-brochure'
    > &
      Schema.Attribute.Private;
...
export interface ApiDistinguishedAlumnDistinguishedAlumn
  extends Struct.CollectionTypeSchema {
  collectionName: 'distinguished_alumni';
  info: {
    displayName: 'Distinguished-alumni';
    pluralName: 'distinguished-alumni';
    singularName: 'distinguished-alumn';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::distinguished-alumn.distinguished-alumn'
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEssf3rdYearEssf3rdYear extends Struct.SingleTypeSchema {
  collectionName: 'essf_3rd_years';
  info: {
    displayName: 'ESSF-3rd-Year';
    pluralName: 'essf-3rd-years';
    singularName: 'essf-3rd-year';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::essf-3rd-year.essf-3rd-year'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEssf4thYearEssf4thYear extends Struct.SingleTypeSchema {
  collectionName: 'essf_4th_years';
  info: {
    displayName: 'ESSF-4th-Year';
    pluralName: 'essf-4th-years';
    singularName: 'essf-4th-year';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::essf-4th-year.essf-4th-year'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiInternshipsBTechInternshipsBTech
  extends Struct.CollectionTypeSchema {
  collectionName: 'internships_b_teches';
  info: {
    description: '';
    displayName: 'Internships-B.tech';
    pluralName: 'internships-b-teches';
    singularName: 'internships-b-tech';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::internships-b-tech.internships-b-tech'
    > &
      Schema.Attribute.Private;
    pdf: Schema.Attribute.Component<'pdf.pdf', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiInternshipsMTechAidaInternshipsMTechAida
  extends Struct.CollectionTypeSchema {
  collectionName: 'internships_m_tech_aidas';
  info: {
    displayName: 'Internships-M.tech(AIDA)';
    pluralName: 'internships-m-tech-aidas';
    singularName: 'internships-m-tech-aida';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::internships-m-tech-aida.internships-m-tech-aida'
    > &
      Schema.Attribute.Private;
    pdf: Schema.Attribute.Component<'pdf.pdf', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiInternshipsMTechIInternshipsMTechI
  extends Struct.CollectionTypeSchema {
  collectionName: 'internships_m_tech_is';
  info: {
    displayName: 'Internships-M.tech(IS)';
    pluralName: 'internships-m-tech-is';
    singularName: 'internships-m-tech-i';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::internships-m-tech-i.internships-m-tech-i'
    > &
      Schema.Attribute.Private;
    pdf: Schema.Attribute.Component<'pdf.pdf', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiInternshipsMTechInternshipsMTech
  extends Struct.CollectionTypeSchema {
  collectionName: 'internships_m_teches';
  info: {
    description: '';
    displayName: 'Internships-M.tech';
    pluralName: 'internships-m-teches';
    singularName: 'internships-m-tech';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::internships-m-tech.internships-m-tech'
    > &
      Schema.Attribute.Private;
    pdf: Schema.Attribute.Component<'pdf.pdf', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProgrammeBTechProgrammeBTech
  extends Struct.CollectionTypeSchema {
  collectionName: 'programme_b_teches';
  info: {
    description: '';
    displayName: 'Programme-B.tech';
    pluralName: 'programme-b-teches';
    singularName: 'programme-b-tech';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::programme-b-tech.programme-b-tech'
    > &
      Schema.Attribute.Private;
    pdf: Schema.Attribute.Component<'pdf.pdf', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProgrammeMTechAidaProgrammeMTechAida
  extends Struct.CollectionTypeSchema {
  collectionName: 'programme_m_tech_aidas';
  info: {
    displayName: 'Programme-M.tech(AIDA)';
    pluralName: 'programme-m-tech-aidas';
    singularName: 'programme-m-tech-aida';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::programme-m-tech-aida.programme-m-tech-aida'
    > &
      Schema.Attribute.Private;
    pdf: Schema.Attribute.Component<'pdf.pdf', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProgrammeMTechIProgrammeMTechI
  extends Struct.CollectionTypeSchema {
  collectionName: 'programme_m_tech_is';
  info: {
    displayName: 'Programme-M.tech(IS)';
    pluralName: 'programme-m-tech-is';
    singularName: 'programme-m-tech-i';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::programme-m-tech-i.programme-m-tech-i'
    > &
      Schema.Attribute.Private;
    pdf: Schema.Attribute.Component<'pdf.pdf', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProgrammeMTechProgrammeMTech
  extends Struct.CollectionTypeSchema {
  collectionName: 'programme_m_teches';
  info: {
    displayName: 'Programme-M.tech';
    pluralName: 'programme-m-teches';
    singularName: 'programme-m-tech';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::programme-m-tech.programme-m-tech'
    > &
      Schema.Attribute.Private;
    pdf: Schema.Attribute.Component<'pdf.pdf', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProgrammesInfoProgrammesInfo
  extends Struct.CollectionTypeSchema {
  collectionName: 'programmes_infos';
  info: {
    description: '';
    displayName: 'Programmes-info';
    pluralName: 'programmes-infos';
    singularName: 'programmes-info';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::programmes-info.programmes-info'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::completed-ph-d.completed-ph-d': ApiCompletedPhDCompletedPhD;
      'api::csea.csea': ApiCseaCsea;
      'api::dcc.dcc': ApiDccDcc;
      'api::deparment-brochure.deparment-brochure': ApiDeparmentBrochureDeparmentBrochure;
      'api::distinguished-alumn.distinguished-alumn': ApiDistinguishedAlumnDistinguishedAlumn;
      'api::download.download': ApiDownloadDownload;
      'api::essf-3rd-year.essf-3rd-year': ApiEssf3rdYearEssf3rdYear;
      'api::essf-4th-year.essf-4th-year': ApiEssf4thYearEssf4thYear;
      ...
      'api::internships-b-tech.internships-b-tech': ApiInternshipsBTechInternshipsBTech;
      'api::internships-m-tech-aida.internships-m-tech-aida': ApiInternshipsMTechAidaInternshipsMTechAida;
      'api::internships-m-tech-i.internships-m-tech-i': ApiInternshipsMTechIInternshipsMTechI;
      'api::internships-m-tech.internships-m-tech': ApiInternshipsMTechInternshipsMTech;
      ...
      'api::programme-b-tech.programme-b-tech': ApiProgrammeBTechProgrammeBTech;
      'api::programme-m-tech-aida.programme-m-tech-aida': ApiProgrammeMTechAidaProgrammeMTechAida;
      'api::programme-m-tech-i.programme-m-tech-i': ApiProgrammeMTechIProgrammeMTechI;
      'api::programme-m-tech.programme-m-tech': ApiProgrammeMTechProgrammeMTech;
      'api::programmes-info.programmes-info': ApiProgrammesInfoProgrammesInfo;
